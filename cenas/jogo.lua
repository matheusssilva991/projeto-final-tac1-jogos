...
function Jogo:new()
    ...
    tipos_inimigos = {{vel = Vector(40, 40), pos = Vector(-500, 200), dano=5, vida=100, op=1, vel_max=80, raio=150},
                      {vel = Vector(15, 15), pos = Vector(-100, 300), dano=5, vida=100, op=2, vel_max=30, raio=100},
                      {vel = Vector(30, 30), pos = Vector(-100, 400), dano=5, vida=100, op=3, vel_max=60, raio=120},
                      {vel = Vector(25, 25), pos = Vector(-300, 400), dano=15, vida=100, op=4, vel_max=50, raio=100}}
